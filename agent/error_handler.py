...
def analyze_error(
    ...
    if attempt >= max_attempts:
        ...
        return {
            ...
            "max_retries":   0,
            "user_message":  "Trying a different approach, jefe."
        }
...
Attempt number: {attempt}"""
    ...
    try:
        ...
        if step.get("critical") and result["decision"] == ErrorDecision.SKIP:
            ...
            result["user_message"] = "This step is critical — finding alternative approach, jefe."
        ...
        return {
            ...
            "max_retries":    1,
            "user_message":   "Encountered an issue, adjusting approach, jefe."
        }
